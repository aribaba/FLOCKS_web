<?php
    ...
    echo "<ul class='favorite-archive'>";
    if ($favorite_post_ids) {
        ...
        while ( have_posts() ) : the_post();
            echo "<li class='favorite-article-single'>";
            echo "<a href='".get_permalink()."' title='". get_the_title() ."'>";
            echo "<ul class='favorite-line'>";
            echo "<li class='favorite-thumbnail'>".get_the_post_thumbnail()."</li>";
            echo "<li class='favorite-title'>".get_the_title()."</li>";
            echo "</ul>";
            echo "</a> ";
